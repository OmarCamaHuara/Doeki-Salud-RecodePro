...
$sql = "SELECT u.nome AS nome, c.descricao AS descricao FROM comentarios AS c INNER JOIN usuarios AS u";
...
<body>
    ...
    ?>
        <div class="container">
            ...
            <button class="btn btn-danger" onclick="confirmar()">Deletar Comentario</button>
        </div>
    ...
    <script>
        function confirmar() {
            let confirmacao = confirm("Você realmente deseja deletar o Comentario??");
